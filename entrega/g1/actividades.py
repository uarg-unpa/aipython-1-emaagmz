...
msj1 = "Solo podemos ver poco del futuro,"
msj2 = "pero lo suficiente para darnos cuenta de que hay mucho que hacer."
print(msj1, msj2)
...
# 3 y 4
nombre = "Emanuel" #String
apellido = "Gomez" #String
edad = 22 #Int
altura = "1.80" #Float
num_vuelo = 2777 #Int
temp = "22°" #String
salario_mensual = "2200" #String
game_over = "" #String vacío
num_par = 2 #Int
